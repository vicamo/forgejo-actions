# Forgejo Actions Template Using TypeScript
...
[Actions tab](https://github.com/vicamo/forgejo-actions/actions)! :rocket:
...
steps:
  ...
  - name: Test Local Action
    id: test-action
    uses: vicamo/forgejo-actions@v1 # Commit with the `v1` tag
    with:
      milliseconds: 1000
